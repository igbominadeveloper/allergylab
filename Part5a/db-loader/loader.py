    ...
    try:
        ...
        for filename in csv_files:
            ...
            with open(filename, mode="r") as file:
                ...
                for row in csv_data:
                    query = f"INSERT INTO `foods` (`id`,`name`,`lab_product`,`serving_size_g`,`gluten_g`,`lactose_g`,`egg_g`,`alpha_gal_g`,`ara_h_1_g`,`ara_h_3_g`,`fructose_g`) VALUES ({
                        row[0]
                    ...
                    # 'Catch' any exceptions
                        ...
                        conn.rollback()
                os.remove(filename)  # Remove the file once complete
